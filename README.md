...
## Environments
- Preview: https://main--myaemsite--ocaiorod.aem.page/
- Live: https://main--myaemsite--ocaiorod.aem.live/
...
1. Open the `myaemsite` directory in your favorite IDE and start coding :)
